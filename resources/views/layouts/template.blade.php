...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('libs/material/css/all.css') }}">
  <!-- Material Icons -->
  <link href="https://fonts.googleapis.com/icon?family=Material+Icons+Round" rel="stylesheet">
  <!-- Material Kit CSS -->
  <link href="{{asset('libs/material/css/material-kit.css') }}" rel="stylesheet" />
</head>
        ...
        <ul class="navbar-nav navbar-nav-hover ms-auto">
          <li class="nav-item dropdown dropdown-hover mx-2 ms-lg-6">
            <a class="nav-link ps-2 d-flex cursor-pointer align-items-center" id="dropdownMenuPages2" data-bs-toggle="dropdown" aria-expanded="false">
              ...
              Pages
              <img src="{{ asset('libs/material/img/down-arrow-white.svg') }}" alt="down-arrow" class="arrow ms-auto ms-md-2 d-lg-block d-none">
              <img src="{{ asset('libs/material/img/down-arrow-dark.svg') }}" alt="down-arrow" class="arrow ms-auto ms-md-2 d-lg-none d-block">
            </a>
          </li>
        ...
        <div class="col-md-3 mb-4 ms-auto">
          <div>
            <a href="https://www.creative-tim.com/product/material-kit">
              <img src="{{ asset('libs/material/img/logo-ct-dark.png') }}" class="mb-3 footer-logo" alt="main_logo">
            </a>
